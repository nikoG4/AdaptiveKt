# Phase 4.4 — Column Sorting & Configuration Plan (GLM)

> Estado: **plan / diseño únicamente.** No implementa código productivo. No implementa UI, snapshots remotos ni paginación.

- **Rama:** `spike/data-column-sorting-config-plan-glm`
- **Base:** `origin/feat/production-data-workflows` (`e6fa248fd1276c993fea49987f9974c0afa39f37`)
- **Antecedente:** spike previo `spike/data-column-sorting-config-opencode` (Nemotron) — auditado y descartado. Ver `docs/internal/AUDIT_spike_data_column_sorting_config.md` (movido a backup `..\AdaptiveKt_failed_spike_backup\`).
...
8. **Nada de trabajo sin commitear.** Todo entregable de este plan se confirma en rama `spike/...-plan-glm`; no se aceptan archivos untracked.
