...
private fun printAdminDemoHelp() {
    ...
    println("  --capture")
    println("  --screen <dashboard|employees|products|invoices|settings|components|components-buttons|components-badges|components-avatars|components-cards|components-dropdowns|components-fields|components-selects|components-multiselects|components-carousels|components-navigation-tree|components-feedback>")
    println("  --width <int>")
    println("  --height <int>")
    println("  --output <path>")
